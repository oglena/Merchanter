    ...
    public class CustomerController( ICustomerService customerService ) :ControllerBase {
            ...
            if( int.TryParse( CID, out customer_id ) && customer_id > 0 ) {
                if( _api_filter.Pager != null ) {
                    ...
                    if( customer_logs != null ) {
                        ...
                        return Ok( new BaseResponseModel<Customer>() { Success = false, Data = null, ErrorMessage = "Error getting customer logs." } );
                    }
                }
            ...
            if( int.TryParse( CID, out customer_id ) && customer_id > 0 ) {
                if( _api_filter.Pager != null && _api_filter.Filters != null ) {
                    ...
                    if( customer_notifications != null ) {
                        ...
                        return Ok( new BaseResponseModel<Customer>() { Success = false, Data = null, ErrorMessage = "Error getting customer notifications." } );
                    }
                }
                return StatusCode( 500 );
            }
        ...
        public async Task<ActionResult<BaseResponseModel<Customer?>>> SaveCustomer( string CID, [FromBody] Customer _customer ) {
            ...
            if( int.TryParse( CID, out customer_id ) && customer_id > 0 ) {
                ...
                if( customer != null ) {
                    return Ok( new BaseResponseModel<Customer>() { Success = true, Data = customer ?? new(), ErrorMessage =  "" } );
                }
                else {
                    return Ok( new BaseResponseModel<List<Customer>>() { Success = false, Data = null, ErrorMessage = "Error save customer" } );
                }
            }
            return BadRequest( "Invalid customer ID." );
        }
