...
namespace ApiService.Repositories {
    ...
    public class SettingsRepository(MerchanterService merchanterService) : ISettingsRepository {
        ...
        public async Task<SettingsMerchanter?> GetSettings(int _customer_id) {
            return await merchanterService.Helper.LoadSettings(_customer_id);
        }

        public async Task<List<ActiveIntegration>?> GetActiveIntegrations(int _customer_id) {
            return await merchanterService.Helper.LoadActiveIntegrations(_customer_id);
        }

        public async Task<bool> SaveGeneralSettings(int _customer_id, SettingsGeneral _settings) {
            return await merchanterService.Helper.SaveCustomerSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveEntegraSettings(int _customer_id, SettingsEntegra _settings) {
            return await merchanterService.Helper.SaveEntegraSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveNetsisSettings(int _customer_id, SettingsNetsis _settings) {
            return await merchanterService.Helper.SaveNetsisSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveMagentoSettings(int _customer_id, SettingsMagento _settings) {
            return await merchanterService.Helper.SaveMagentoSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveShipmentSettings(int _customer_id, SettingsShipment _settings) {
            return await merchanterService.Helper.SaveShipmentSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveOrderSettings(int _customer_id, SettingsOrder _settings) {
            return await merchanterService.Helper.SaveOrderSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveProductSettings(int _customer_id, SettingsProduct _settings) {
            return await merchanterService.Helper.SaveProductSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveInvoiceSettings(int _customer_id, SettingsInvoice _settings) {
            return await merchanterService.Helper.SaveInvoiceSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveN11Settings(int _customer_id, SettingsN11 _settings) {
            return await merchanterService.Helper.SaveN11Settings(_customer_id, _settings);
        }

        public async Task<bool> SaveHBSettings(int _customer_id, SettingsHB _settings) {
            return await merchanterService.Helper.SaveHBSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveTYSettings(int _customer_id, SettingsTY _settings) {
            return await merchanterService.Helper.SaveTYSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveAnkErpSettings(int _customer_id, SettingsAnkaraErp _settings) {
            return await merchanterService.Helper.SaveAnkERPSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveIdeasoftSettings(int _customer_id, SettingsIdeasoft _settings) {
            return await merchanterService.Helper.SaveIdeasoftSettings(_customer_id, _settings);
        }

        public async Task<bool> SaveGoogleSettings(int _customer_id, SettingsGoogle _settings) {
            return await merchanterService.Helper.SaveGoogleSettings(_customer_id, _settings);
        }
    }
}
