...
public class M2_InvoiceRequestInvoiceItems {
    public M2_InvoiceRequestInvoice_Extension_Attributes extension_attributes { get; set; }
    public int order_item_id { get; set; }
    public int qty { get; set; }
}

public class M2_InvoiceRequestInvoiceComment {
    public M2_InvoiceRequestInvoice_Extension_Attributes extension_attributes { get; set; }
    public string comment { get; set; }
    public int is_visible_on_front { get; set; }
}

public class M2_InvoiceRequestInvoiceArguments {
    public M2_InvoiceRequestInvoice_Extension_Attributes extension_attributes { get; set; }
}

public class M2_InvoiceRequestInvoice_Extension_Attributes {
