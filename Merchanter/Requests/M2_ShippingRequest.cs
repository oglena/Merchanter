namespace Merchanter.Requests {
    public record class M2_ShippingRequest {
    ...
    public record class M2_ShippingRequestShipment_Comment {
    ...
    public record class M2_ShippingRequestShipment_Track {
        public M2_ShippingRequestShipment_Extension_Attributes extension_attributes { get; set; }
    ...
    public record class M2_ShippingRequestShipment_Extension_Attributes {
