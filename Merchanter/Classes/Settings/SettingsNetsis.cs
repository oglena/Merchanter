namespace Merchanter.Classes.Settings {
    public class SettingsNetsis {
        ...
        public string cari_siparis_grupkodu { get; set; } = "0=WEBM2|BANKA_TRANSFERİ=WEBM2-H";
        ...
        public string ebelge_dizayn_earsiv { get; set; } = string.Empty;
        public string ebelge_dizayn_efatura { get; set; } = string.Empty;
        public string ebelge_klasorismi { get; set; } = "NetsisFATURA";
        public string efatura_belge_onek { get; set; } = string.Empty;
        public string earsiv_belge_onek { get; set; } = string.Empty;
