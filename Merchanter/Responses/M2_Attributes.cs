namespace Merchanter.Responses {
    ...
    public record class M2_FrontendLabel {
        public int store_id { get; set; }
        public string label { get; set; }
    }

    public record class M2_SearchCriteria {
    ...
    public record class M2_Filters {
        public M2_Filter[] filters { get; set; }
    }

    public record class M2_Filter {
