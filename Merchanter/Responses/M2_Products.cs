namespace Merchanter.Responses {
    ...
    public record class M2_ProductExtensionAttributes {
    ...
    public record class M2_ProductCategoryLinks {
        public int position { get; set; }
        public string category_id { get; set; }
    }

    public record class M2_ProductProductLinks {
        public string sku { get; set; }
    ...
    public record class M2_ProductMediaGalleryEntries {
        public int id { get; set; }
    ...
    public record class M2_ProductExtensionAttributesVideo {
        public M2_ProductVideoContent video_content { get; set; }
    }

    public record class M2_ProductVideoContent {
        public string media_type { get; set; }
    ...
    public record class M2_ProductCustomAttributes {
        public string attribute_code { get; set; }
        public object? value { get; set; }
    }


    public record class M2_BundleOption {
    ...
    public record class M2_Product_Links {
        public string sku { get; set; }
        public int option_id { get; set; }
    ...
    public record class M2_ConfigurableOption {
        public int id { get; set; }
    ...
    public record class M2_ConfigurableOptionValue {
        public int? value_index { get; set; }
    }

    public record class M2_ProductType {
        public string name { get; set; }
        public string label { get; set; }
    }
}