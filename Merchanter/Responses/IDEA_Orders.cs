...
public class IDEA_Orders {
    public IDEA_Order[] orders { get; set; }
}

public class IDEA_Order {
...
public class IDEA_Maillist {
    public int id { get; set; }
    public string name { get; set; }
    public string email { get; set; }
}

public class IDEA_Member {
    public int id { get; set; }
...
public class IDEA_Shippingaddress {
    public int id { get; set; }
    public string firstname { get; set; }
    public string surname { get; set; }
...
public class IDEA_Billingaddress {
    public int id { get; set; }
    public string firstname { get; set; }
    public string surname { get; set; }
    public string country { get; set; }
...
public class IDEA_Orderdetail {
    public int id { get; set; }
    public string varKey { get; set; }
    public string varValue { get; set; }
}

public class IDEA_Orderitem {
    public int id { get; set; }
