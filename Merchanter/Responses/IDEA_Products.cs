namespace Merchanter.Responses {
    public record class IDEA_Products {
        public IDEA_Product[] products { get; set; }
    }

    public record class IDEA_Product {
    ...
    public record class IDEA_Currency {
        public int id { get; set; }
        public string label { get; set; }
        public string abbr { get; set; }
    }

    public record class IDEA_Brand {
        public int id { get; set; }
        public string name { get; set; }
        public string pageTitle { get; set; }
        public string metaDescription { get; set; }
    ...
    public record class IDEA_Detail {
        public int? id { get; set; }
        public string details { get; set; }
        public object extraDetails { get; set; }
    }

    public record class IDEA_PCategory {
        public int id { get; set; }
        public string name { get; set; }
    ...
    public record class IDEA_Image {
        public int id { get; set; }
