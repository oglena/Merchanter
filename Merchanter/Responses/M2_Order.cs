namespace Merchanter.Responses {
    ...
    public record class M2_Billing_Address {
    ...
    public record class M2_Payment {
    ...
    public record class M2_Extension_Attributes {
    ...
    public record class M2_ItemApplied_Taxes {
        public string type { get; set; }
        public string item_id { get; set; }
        public M2_Applied_Taxes[] applied_taxes { get; set; }
    }

    public record class M2_Applied_Taxes {
    ...
    public record class M2_Shipping_Assignments {
        public M2_Shipping shipping { get; set; }
        public M2_Order_Item[] items { get; set; }
    }

    public record class M2_Payment_AdditionalInfo {
        public string key { get; set; }
        public string value { get; set; }
    }

    public record class M2_Configurable_Item_Options {
        public int option_id { get; set; }
        public int option_value { get; set; }
    }

    public record class M2_Bundle_Options {
        public int option_id { get; set; }
        public int option_qty { get; set; }
        public int[] option_selections { get; set; }
    }

    public record class M2_Shipping {
        public M2_Address address { get; set; }
        public string method { get; set; }
        public M2_Total total { get; set; }
    }

    public record class M2_Address {
        public string address_type { get; set; }
        public string city { get; set; }
        public string country_id { get; set; }
    ...
    public record class M2_Order_Item {
    ...
    public record class M2_Product_Option {
        public M2_Extension_Attributes extension_attributes { get; set; }
    }

    public record class M2_Status_Histories {
